...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!id) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} | Geçerli bir kullanıcı id'si girmelisin.`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
